...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        # self.Outlook = OutlookAttention(dim=2048)
        self.rgablock = RGA_Module(1024, 14*6)
...
class OutlookAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # 映射到新的特征v
        v = self.v_pj(x.permute(0, 2, 3, 1)).permute(0, 3, 1, 2)  # B,C,H,W
        ...
        # 生成Attention Map
        attn = self.pool(x).permute(0, 2, 3, 1)  # B,H,W,C
